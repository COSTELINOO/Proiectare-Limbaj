    ...
    | TIP NUME '=' conditie ';'
    {
        ...
        if(strcmp($1,$4.tip)!=0)
            cout<<"Eroare la linia "<<yylineno<< ": \""<< $1 <<"\" si " << $4.tip <<" nu au acelasi tip(1)\n",errorCount++;
        else
        {
    ...
    |NUME NUME ';'
    {
        ...
        {
            cout<<"Eroare la linia "<<yylineno<< ": \""<< $1 <<"\" tip necunoscut(2)\n",errorCount++;
        }
        else  if(current->isDefined($1)==true)
        {
            cout<<"Eroare la linia "<<yylineno<< ": \""<< $1 <<"\" este deja definit(3)\n",errorCount++;
        }
        else
            current->addVariabila($1,$2);
    }
...

    {
        ...
        if(strcmp(aux1,$10.tip)!=0)
            {cout<<"Eroare la linia "<<yylineno<< ": functia si "<< $10.val <<" nu au acelasi tip(4)\n";errorCount++;}
    ...
    FOR '(' NUME '=' conditie ';' conditie ';' NUME '=' NUME '+' conditie ')' '{'
    {
        ...
        {
            cout<<"Eroare la linia "<<yylineno<< ""<<  "o variabila nu este definita(5)\n";
            errorCount++;
        }
        else if(strcmp(aux1->tip.c_str(),$5.tip)!=0||strcmp(aux2->tip.c_str(),aux3->tip.c_str())!=0||strcmp(aux2->tip.c_str(),$13.tip)!=0)
        {
            cout<<"Eroare la linia "<<yylineno<< ""<<  "tipuri incompatibile(6)\n";
            errorCount++;
        }
        else
        {
    ...
    | FOR '(' TIP NUME '=' conditie ';' conditie ';' NUME '=' NUME '+' conditie ')' '{'
    {
        ...
        {
            cout<<"Eroare la linia "<<yylineno<< ""<<  " o variabila nu este definita(7)\n";
            errorCount++;
        }
        else if(strcmp($3,$6.tip)!=0||strcmp(aux1->tip.c_str(),aux2->tip.c_str())!=0||strcmp(aux2->tip.c_str(),$14.tip)!=0)
        {
            cout<<"Eroare la linia "<<yylineno<< ""<<  " tipuri incompatibile(8)\n";
            errorCount++;
        }
        else
        {
    ...
    NUME '=' conditie ';'
    {
        ...
        {
            cout<<"Eroare la linia "<<yylineno<< ": \""<< $1<<"\" nu este definit(9)\n";
            errorCount++;
        }
        else if(aux==nullptr||strcmp(aux->tip.c_str(),$3.tip)!=0)
        {
            cout<<"Eroare la linia "<<yylineno<< ": " <<" tipuri incompatibile(10)\n";
            errorCount++;
        }
        else
        {
    ...
    | NUME '(' { param_value.clear();} param_val ')' ';'
    {
        ...
        if(aux==nullptr)
            cout<<"Eroare la linia "<<yylineno<< ": \""<< $1<<"\" nu este definita(11)\n",errorCount++;

        else if(param_value.size()!=aux->param.size()&&aux->tip_scop!="CLASA:")
        {

            cout<<"Eroare la linia "<<yylineno<< ": "<< "numar de argumente invalide(12)\n";errorCount++;
        }
        else if(aux->tip_scop=="CLASA:")
        {
            ...
            {
                cout<<"Eroare la linia "<<yylineno<< ": \""<< $1<<"\" nu este definita(13)\n";errorCount++;
            }
            else
            {
                bool gasit=true;
                ...
                if(gasit==false)
                    cout<<"Eroare la linia "<<yylineno<< ": "<< "tipuri invalide(14)\n",errorCount++;
            }
        ...
        else
        {
            ...
            if(gasit==false)
                cout<<"Eroare la linia "<<yylineno<< ": "<< "tipuri invalide(15)\n",errorCount++;
        }
    ...
    | NUME '.' NUME ';'
    {
        ...
        if(aux==nullptr)
            cout<<"Eroare la linia "<<yylineno<< ": \""<< $1<<"\" clasa nu este definita(14)\n",errorCount++;
        else
        {
            ...
            if(aux2->existsVariabila($3)==false)
                cout<<" Eroare la linia "<<yylineno<< ": \""<< $3<<"\" nu este definit(15)\n",errorCount++;
        }
    ...
    | NUME '[' INTEGER ']' '=' conditie ';'
    {
        ...
        {
            cout<<"Eroare la linia "<<yylineno<< ": \"" << $1<<"\" nu este definit(16)\n";errorCount++;
        }
        else
        {
            ...
            if(current->isDefined($1)!=true)
            {
                cout<<"Eroare la linia "<<yylineno<< ": \""<< $1<<"\" nu este definit(17)\n";errorCount++;
            }
            else if(aux==nullptr||strcmp(aux->tip.c_str(),$6.tip)!=0)
            {
                cout<<"Eroare la linia "<<yylineno<< ": " <<" tipuri incompatibile(18)\n";errorCount++;
            }
            else
            {
                SymTable *ar=current->getScope($1);
    ...
    | NUME '.' NUME '=' conditie ';'
    {
        SymTable *aux=current->getScope($1);
        if(aux==nullptr)
            cout<<"Eroare la linia "<<yylineno<< ": \""<< $1<<"\" clasa nu este definita(19)\n",errorCount++;
        else
        {
            SymTable *aux2=nullptr;
            string tip=aux->getType($1);
            ...
            if(aux2->existsVariabila($3)==false)
                cout<<" Eroare la linia "<<yylineno<< ": \""<< $3<<"\" nu este definit(20)\n",errorCount++;
    ...
    | NUME '.' NUME '(' { param_value.clear();} param_val ')' ';'
    {
        ...
        if(aux==nullptr)
        {	cout<<"Eroare la linia "<<yylineno<< ": \""<< $1<<"\" clasa nu este definita(33)\n";
            errorCount++;
        }
        ...
        else
        {
            ...
            if(aux==nullptr)
            {	cout<<" Eroare la linia "<<yylineno<< ": \""<< $3<<"\" nu este definit(34)\n";
                errorCount++;
            }
            else
            {
                ...
                if(gasit==false)
                {	cout<<"Eroare la linia "<<yylineno<< ": "<< "tipuri invalide(35)\n";errorCount++;
        ...
        {
            {
                ...
                {
                    cout<<"Eroare la linia "<<yylineno<< ": \""<< $1.val<<"\" si \" " << $3.val <<"\" nu acelasi tip(24)\n";errorCount++;
        ...
        {
            {
                ...
                else
                {
                    ...
                    cout<<"Eroare la linia "<<yylineno<< ": \""<< $1.val<<"\" si \" " << $3.val <<"\" nu acelasi tip(25)\n";errorCount++;
        ...
        {
            {
                ...
                {
                    cout<<"Eroare la linia "<<yylineno<< ": \""<< $1.val<<"\" si \" " << $3.val <<"\" nu acelasi tip(26)\n";errorCount++;
        ...
        {
            {
                ...
                {
                    cout<<"Eroare la linia "<<yylineno<< ": \""<< $1.val<<"\" si \" " << $3.val <<"\" nu acelasi tip(27)\n";errorCount++;
        ...
        {
            {
                ...
                {
                    cout<<"Eroare la linia "<<yylineno<< ": \""<< $1.val<<"\" si \" " << $3.val <<"\" nu acelasi tip(28)\n";errorCount++;
        ...
        {
            {
                ...
                {
                    cout<<"Eroare la linia "<<yylineno<< ": \""<< $1.val<<"\" si \" " << $3.val <<"\" nu acelasi tip(29)\n";errorCount++;
        ...
        {
            {
                ...
                {
                    cout<<"Eroare la linia "<<yylineno<< ": \""<< $1.val<<"\" si \" " << $3.val <<"\" nu acelasi tip(30)\n";errorCount++;
        ...
        {
            {
                ...
                {
                    cout<<"Eroare la linia "<<yylineno<< ": \""<< $1.val<<"\" si \" " << $3.val <<"\" nu acelasi tip(31)\n";errorCount++;
    ...
    | NUME
    {
        ...
        {
            cout<<"Eroare la linia "<<yylineno<< ": \""<< $1<<"\" nu este definit(32)\n";
            $$.tip=strdup("");
            $$.val=strdup("");
            $$.rad=new AST(strdup("default"), strdup(""), strdup(""));
        }
    ...
    | NUME '(' {param_value.clear();} param_val ')'
    {
        ...
        if(aux==nullptr)
        {	cout<<"Eroare la linia "<<yylineno<< ": \""<< $1<<"\" nu este definita(36)\n";errorCount++;
            $$.tip=strdup("");
            $$.val=strdup("");
             $$.rad=new AST(strdup("default"), strdup(""), strdup(""));
        }
        ...
        else if(param_value.size()!=aux->param.size()&&aux->tip_scop!="CLASA:")
        {
            ...
            cout<<" Eroare la linia "<<yylineno<< ": "<< "numar de argumente invalide(37)\n";errorCount++;
            $$.tip=strdup("");
             $$.rad=new AST(strdup("default"), strdup(""), strdup(""));
            $$.val=strdup("");
        }
        else if(aux->tip_scop=="CLASA:")
        {
            ...
            if(aux!=nullptr &&aux->nume!=$1)
            {
                cout<<"Eroare la linia "<<yylineno<< ": \""<< $1<<"\" nu este definita(38)\n";errorCount++;
                $$.tip=strdup("");
                $$.val=strdup("");
                 $$.rad=new AST(strdup("default"), strdup(""), strdup(""));
            }
            else
            {
                ...
                if(gasit==false)
                {	cout<<"Eroare la linia "<<yylineno<< ": "<< "tipuri invalide(39)\n";errorCount++;
 ...
 $$.rad=new AST(strdup("default"), strdup(""), strdup(""));
    ...
    | NUME '[' INTEGER ']' {
        if(current->isDefined($1)!=true)
        {
            cout<<"Eroare la linia "<<yylineno<< ": \"" << $1<<"\" nu este definit(40)\n";errorCount++;
            $$.tip=strdup("");
            $$.val=strdup("");
        }
        else
        {
            ...
            if(current->isDefined($1)!=true)
            {
                cout<<"Eroare la linia "<<yylineno<< ": \""<< $1<<"\" nu este definit(41)\n";errorCount++;
                $$.tip=strdup("");
                $$.val=strdup("");
            }
            else if(aux==nullptr)
            {
                cout<<"Eroare la linia "<<yylineno<< ": " <<" indexul nu este intreg(42)\n";errorCount++;
                $$.tip=strdup("");
    ...
    | NUME '.' NUME
    {
        SymTable *aux=current->getScope($1);
        if(aux==nullptr)
        {	cout<<"Eroare la linia "<<yylineno<< ": \""<< $1<<"\" clasa nu este definita(43)\n";errorCount++;
            $$.tip=strdup("");
            $$.val=strdup("");
             $$.rad=new AST(strdup("default"), strdup(""), strdup(""));
        }
